...
using App.Services.Tournaments.Infrastructure;
...
builder.Services.AddAutoMapper(Assembly.Load("App.Services.Tournaments.Infrastructure"));

builder.Services.AddMongoDb();
builder.Services.AddRabbitMq(Assembly.Load("App.Services.Tournaments.Infrastructure"));
...
await entityIndexGenerator.Generate(Assembly.Load("App.Services.Tournaments.Data"));

app.MapGrpcService<TournamentsGrpcService>();
