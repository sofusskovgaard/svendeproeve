...
using App.Services.Departments.Infrastructure;
...
builder.Services.AddAutoMapper(Assembly.Load("App.Services.Departments.Infrastructure"));

builder.Services.AddMongoDb();
builder.Services.AddRabbitMq(Assembly.Load("App.Services.Departments.Infrastructure"));
...
await entityIndexGenerator.Generate(Assembly.Load("App.Services.Departments.Data"));

app.MapGrpcService<DepartmentsGrpcService>();
