...
using App.Services.Orders.Infrastructure;
...
builder.Services.AddAutoMapper(Assembly.Load("App.Services.Orders.Infrastructure"));
...
await entityIndexGenerator.Generate(Assembly.Load("App.Services.Orders.Data"));
