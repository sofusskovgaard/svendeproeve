...
using App.Services.Games.Infrastructure;
...
builder.Services.AddAutoMapper(Assembly.Load("App.Services.Games.Infrastructure"));

builder.Services.AddMongoDb();
builder.Services.AddRabbitMq(Assembly.Load("App.Services.Games.Infrastructure"));
...
await entityIndexGenerator.Generate(Assembly.Load("App.Services.Games.Data"));
