...
namespace App.Services.Organizations.Infrastructure
{
    public class OrganizationsGrpcService : BaseGrpcService, IOrganizationsGrpcService
    {
        ...
        public ValueTask<GetOrganizationByIdCommandResult> GetOrganizationById(GetOrganizationByIdCommandMessage message)
        {
        ...
        public ValueTask<GetOrganizationsByNameCommandResult> GetOrganizationsByName(GetOrganizationsByNameCommandMessage message)
        {
            return TryAsync(async () =>
            {
        ...
        public ValueTask<GetOrganizationsByAddressCommandResult> GetOrganizationsByAddress(GetOrganizationsByAddressCommandMessage message)
        {
            return TryAsync(async () =>
            {
        ...
        public ValueTask<CreateOrganizationCommandResult> CreateOrganization(CreateOrganizationCommandMessage message)
        {
            return TryAsync(async () =>
            {
                //TODO: masstransit
