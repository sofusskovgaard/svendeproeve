...
public class TeamsController : ApiController
{
    ...
    {
        return TryAsync(() => _teamsGrpcService.GetAllTeams(new GetAllTeamsGrpcCommandMessage()));
    }
    ...
    {
        return TryAsync(() => _teamsGrpcService.GetTeamsByOrganizationId(new GetTeamsByOrganizationIdGrpcCommandMessage
    ...
    {
        return TryAsync(() => _teamsGrpcService.GetTeamsByName(new GetTeamsByNameGrpcCommandMessage { Name = name }));
    }
    ...
    {
        return TryAsync(() =>
            _teamsGrpcService.GetTeamsByMemberId(new GetTeamsByMemberIdGrpcCommandMessage { MemberId = memberid }));
    }
    ...
    {
        return TryAsync(() =>
            _teamsGrpcService.GetTeamsByGameId(new GetTeamsByGameIdGrpcCommandMessage { GameId = gameid }));
    }
    ...
    {
        return TryAsync(() =>
            _teamsGrpcService.GetTeamsByManagerId(new GetTeamsByManagerIdGrpcCommandMessage { ManagerId = managerid }));
    }
    ...
    {
        return TryAsync(() => _teamsGrpcService.GetTeamById(new GetTeamByIdGrpcCommandMessage { Id = id }));
    }
    ...
    {
        return TryAsync(() => _teamsGrpcService.DeleteTeamById(new DeleteTeamByIdGrpcCommandMessage { Id = id }));
    }
