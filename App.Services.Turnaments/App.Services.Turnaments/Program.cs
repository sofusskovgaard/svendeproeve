...
builder.Services.AddAutoMapper(Assembly.Load("App.Services.Turnaments.Infrastructure"));

builder.Services.AddMongoDb();
builder.Services.AddRabbitMq(Assembly.Load("App.Services.Turnaments.Infrastructure"));
...
await entityIndexGenerator.Generate(Assembly.Load("App.Services.Turnaments.Data"));

app.MapGrpcService<TurnamentsGrpcService>();
