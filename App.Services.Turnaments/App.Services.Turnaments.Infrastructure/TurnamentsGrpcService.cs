...
public class TurnamentsGrpcService : BaseGrpcService, ITurnamentsGrpcService
{
    ...
    public ValueTask<GetAllTurnamentsGrpcCommandResult> GetAllTurnaments(GetAllTurnamentsGrpcCommandMessage message)
    {
        ...
        {
            var turnaments = await _entityDataService.ListEntities<TurnamentEntity>();
            ...
            return new GetAllTurnamentsGrpcCommandResult
            {
                ...
                TurnamentDtos = _mapper.Map<IEnumerable<TurnamentDto>>(turnaments)
            };
        });
    }

    public ValueTask<GetTurnamentsByEventIdGrpcCommandResult> GetTurnamentsByEventId(
        GetTurnamentsByEventIdGrpcCommandMessage message)
    {
        return TryAsync(async () =>
        {
            var turnaments = await _entityDataService.ListEntities(
                new ExpressionFilterDefinition<TurnamentEntity>(entity => entity.EventId == message.EventId));
    ...
    public ValueTask<GetTurnamentsByGameIdGrpcCommandResult> GetTurnamentsByGameId(
        GetTurnamentsByGameIdGrpcCommandMessage message)
    {
        return TryAsync(async () =>
        {
            var turnaments = await _entityDataService.ListEntities(
                new ExpressionFilterDefinition<TurnamentEntity>(entity => entity.GameId == message.GameId));
    ...
    public ValueTask<GetTurnamentByMatchIdGrpcCommandResult> GetTurnamentByMatchId(
        GetTurnamentByMatchIdGrpcCommandMessage message)
    {
        return TryAsync(async () =>
        {
            var turnament = await _entityDataService.ListEntities(
                new ExpressionFilterDefinition<TurnamentEntity>(entity => entity.MatchesId.Contains(message.MatchId)));
            ...
            return new GetTurnamentByMatchIdGrpcCommandResult
            {
                ...
                TurnamentDto = _mapper.Map<TurnamentDto>(turnament.FirstOrDefault())
            };
        });
    }
    ...
    public ValueTask<GetTurnamentByIdGrpcCommandResult> GetTuenamentById(GetTurnamentByIdGrpcCommandMessage message)
    {
        return TryAsync(async () =>
        {
            ...
            return new GetTurnamentByIdGrpcCommandResult
            {
                ...
                TurnamentDto = _mapper.Map<TurnamentDto>(turnament)
            };
        });
    }
    ...
    public ValueTask<DeleteTurnamentByIdGrpcCommandResult> DeleteTurnamentById(
        DeleteTurnamentByIdGrpcCommandMessage message)
    {
        return TryAsync(async () =>
        {
    ...
    public ValueTask<GetMatchesByTurnamentIdGrpcCommandResult> GetMatchesByTurnamentId(
